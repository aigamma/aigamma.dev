...
// A zero bid with a positive ask is a "no bid" condition (someone is
// willing to sell but nobody is bidding) and the mid would be ask/2,
// which is not a real mark, so those reject to the close_price path.
