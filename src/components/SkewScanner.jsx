  ...
  return (
    <div style={style}>
      ...
      {/* Anchor / hype rows. Three branches based on what the
          ...
          names get the joint-rank tuple in accent-blue;
          SP500-but-not-anchor names get the hype divergence in
          muted text so a reader can see why they were excluded;
          non-SP500 names are left silent — their absence of any
          SP500 row IS the explanation, and a tooltip line reading
          "non-SP500" doesn't add information beyond what the reader
          can already see from the empty weight column elsewhere. */}
      {t.anchor && (
        <TooltipRow
          label="Anchor 50"
          value={
